...
If(    ([Termijncode].[Code]=="005" AND [@Total net amount]>=ConvertStringToInt("10000")    AND [Relatie].[Code]=="495")
    ...
    OR ([Termijncode].[Code]=="005" AND [@Total net amount]>=ConvertStringToInt("10000")    AND [Relatie].[Code]=="9328")
    OR ([Termijncode].[Code]=="005" AND [@Total net amount]>=ConvertStringToInt("10000")    AND [Relatie].[Code]=="9448")
    ...
    OR ([Termijncode].[Code]=="005" AND [@Total net amount]>=ConvertStringToInt("10000")    AND [Relatie].[Code]=="26009")
    ...
    OR ([Termijncode].[Code]=="006" AND [@Total net amount]>=ConvertStringToInt("10000")    AND [Relatie].[Code]<>"150"
                                                                                            ...
                                                                                            AND [Relatie].[Code]<>"9328"
                                                                                            AND [Relatie].[Code]<>"9448"
                                                                                            AND [Relatie].[Code]<>"18003"
                                                                                            AND [Relatie].[Code]<>"19017"
                                                                                            AND [Relatie].[Code]<>"26009"
    ...
    OR ([Termijncode].[Code]=="STOW-INT_2"  AND [Relatie].[Code]=="9196"    AND [@Total net amount]< ConvertStringToInt("100000"))
    OR ([Termijncode].[Code]=="STOW-INT_2"  AND [Relatie].[Code]=="9259"    AND [@Total net amount]< ConvertStringToInt("100000"))
